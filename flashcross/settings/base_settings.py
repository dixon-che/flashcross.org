"""
Django settings for flashcross project.
...
SECRET_KEY = '*6nq4_6pf!l-pferzp-px32sdtbm@o64wrh&^($7myu&8xiyqx'
...
ROOT_URLCONF = 'flashcross.urls'


WSGI_APPLICATION = 'flashcross.wsgi.application'
